...
-- GoTrue's Go scanner reads confirmation_token/recovery_token/etc as plain
-- strings, not nullable — leaving them NULL (the column default) makes
-- every subsequent login fail with "Database error querying schema"
-- (sql: Scan error ... converting NULL to string is unsupported). They must
-- be explicit empty strings for manually-inserted users.
...
insert into public.barbers (id, name, bio, avatar_url, specialties, active) values
  ('20000000-0000-4000-8000-000000000001', 'Marcus Reed', 'Классические стрижки и уходовое бритьё, 12 лет за креслом.', null, array['classic cuts', 'straight razor shave'], true),
  ('20000000-0000-4000-8000-000000000002', 'Dante Kovacs', 'Фейд, дизайн бороды, современные текстуры.', null, array['fades', 'beard design'], true),
  ('20000000-0000-4000-8000-000000000003', 'Leo Santos', 'Барбер широкого профиля, специализация — детские стрижки.', null, array['kids cuts', 'classic cuts'], true),
  ('20000000-0000-4000-8000-000000000004', 'Sam Okafor', 'Экспериментальные стрижки и укладка.', null, array['fades', 'styling'], false);

-- Services
insert into public.services (id, name, description, duration_min, price, active) values
  ('30000000-0000-4000-8000-000000000001', 'Классическая стрижка', 'Стрижка машинкой и ножницами, укладка.', 45, 35.00, true),
  ('30000000-0000-4000-8000-000000000002', 'Стрижка + борода', 'Стрижка и оформление бороды.', 60, 50.00, true),
  ('30000000-0000-4000-8000-000000000003', 'Оформление бороды', 'Стрижка, контур, горячее полотенце.', 30, 25.00, true),
  ('30000000-0000-4000-8000-000000000004', 'Королевское бритьё', 'Бритьё опасной бритвой с горячим полотенцем.', 40, 40.00, true),
  ('30000000-0000-4000-8000-000000000005', 'Фейд', 'Плавный переход, чёткие линии.', 45, 40.00, true),
  ('30000000-0000-4000-8000-000000000006', 'Детская стрижка', 'Стрижка для детей до 12 лет.', 30, 25.00, true),
  ('30000000-0000-4000-8000-000000000007', 'Камуфляж седины', 'Тонирование седины, натуральный результат.', 30, 30.00, true);
...
insert into public.time_off (barber_id, start_at, end_at, reason) values
  ('20000000-0000-4000-8000-000000000001', now() + interval '7 days', now() + interval '9 days', 'Отпуск');
...
insert into public.appointments (barber_id, service_id, customer_id, start_at, end_at, status, notes) values
  ('20000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000001',
   '10000000-0000-4000-8000-000000000002', now() + interval '2 days' + interval '10 hours', now() + interval '2 days' + interval '10 hours 45 minutes',
   'confirmed', null),
  ('20000000-0000-4000-8000-000000000003', '30000000-0000-4000-8000-000000000002',
   '10000000-0000-4000-8000-000000000003', now() + interval '3 days' + interval '14 hours', now() + interval '3 days' + interval '15 hours',
   'pending', 'Впервые, просьба не спешить'),
  ('20000000-0000-4000-8000-000000000001', '30000000-0000-4000-8000-000000000004',
   '10000000-0000-4000-8000-000000000002', now() - interval '5 days' + interval '11 hours', now() - interval '5 days' + interval '11 hours 40 minutes',
   'completed', null),
  ('20000000-0000-4000-8000-000000000002', '30000000-0000-4000-8000-000000000005',
   '10000000-0000-4000-8000-000000000003', now() - interval '2 days' + interval '9 hours', now() - interval '2 days' + interval '9 hours 45 minutes',
